...
extern void hashWriteByte(HashState *hs, uint8_tt byte);
extern void hashFinish(HashState *hs);
extern void writeHashToByteArray(uint8_tt *out, HashState *hs, bool do_write_big_endian);
